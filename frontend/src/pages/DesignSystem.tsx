...
const MOCK_BRIEF: StoryBrief = { suggestedTitle: "How AI is Changing Content Creation", summary: "An exploration of how generative AI tools are reshaping the YouTube creator economy.", articleTitle: "The Rise of AI-Powered Content", articleContent: "Artificial intelligence is transforming the way creators produce, edit, and distribute content across platforms...", script: "Welcome back to the channel. Today we're diving into something that's been reshaping our entire industry...", scriptLength: "long", videoFormat: "long", channelId: "c1", transcript: "So the first thing I want to talk about is how AI tools have completely changed the editing workflow. We used to spend hours on color grading alone, but now with these new models, you can get 90% of the way there in seconds.", transcriptSegments: [{ start: 0, end: 12, text: "So the first thing I want to talk about is how AI tools have completely changed the editing workflow." }, { start: 12, end: 24, text: "We used to spend hours on color grading alone, but now with these new models, you can get 90% of the way there in seconds." }], youtubeDescription: "In this video we explore how AI is changing the content creation landscape...", youtubeTags: ["AI", "content creation", "YouTube"] };
          ...
          {tab === "components" && (
            <>
              ...
              <CidBlock cid="story-script-section" name="StoryDetailScriptSection" source="StoryDetail.tsx">
                <StoryDetailScriptSection scriptLength="long" onScriptLengthChange={NOOP} canGenerate={true} generating={false} onGenerate={NOOP_ASYNC} readOnly={false} showGenerateControls={true} videoFormat="long" onVideoFormatChange={NOOP} channelName="MrBeast" />
              </CidBlock>
