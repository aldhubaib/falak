          ...
          {tab === "components" && (
            <>
              ...
              <CidBlock cid="story-article" name="StoryDetailArticle" source="StoryDetail.tsx">
                <StoryDetailArticle storyId="dls-mock-story" sourceUrl="https://example.com/article" sourceName="NewsAPI/TechCrunch" articleContent={MOCK_BRIEF.articleContent} articleDisplayValue={MOCK_BRIEF.articleContent || ""} articleTitle={MOCK_BRIEF.articleTitle} articleLoading={false} articleError={null} actionsDisabled={false} relativeDate="2 hours ago" articleOpen={true} onArticleOpenChange={NOOP} onCleanup={NOOP_ASYNC} onRefetch={NOOP_ASYNC} onRetryFetch={NOOP_ASYNC} onArticleChange={NOOP} onArticleTitleChange={NOOP} onArticleTitleBlur={NOOP} />
              </CidBlock>
