...
import { LayoutDashboard, Swords, GitBranch, TrendingUp, Sparkles, Settings, Circle, Pin, PinOff, Newspaper, FileText, Zap, Home, Images } from "lucide-react";
...
const navItems = [
  ...
  { icon: Zap, label: "Vector Intelligence", path: "/vector-intelligence" },
